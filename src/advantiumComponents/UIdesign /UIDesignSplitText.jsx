...
export default function UIDesignSplitText() {
    ...
    return (
        <div className="UIDesignsplitText-container  w-full min-h-[100vh]  flex flex-col   justify-center whitespace-normal break-words lg:mt-20 md:mt-0 lg:px-45 md:px-22 overflow-x-hidden  ">
            <h1 className="UIDesign-Text text-start py-5 text-[50px] text-white flex items-center">Wat is User Interface Design?</h1>
            <div
                ref={elRef}

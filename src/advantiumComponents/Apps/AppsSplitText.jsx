...
export default function AppsSplitText() {
    ...
    return (
        <div className="appssplitText-container  w-full min-h-[100vh]  flex flex-col   justify-center whitespace-normal break-words lg:mt-20 md:mt-[-100px] lg:px-45 md:px-22 overflow-x-hidden  ">

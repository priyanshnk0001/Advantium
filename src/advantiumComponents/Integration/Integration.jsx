        ...
        <>
            ...
            >
                ...
                <div className="Integration-ad-Content-cont w-[100%]   flex flex-col   items-center   text-start px-[54px]   ">
                    <h1 className='Integration-headingText text-[110px] text-white  text-start self-start leading-none mt-[220px]'>Experienced in building integrations.</h1>
                    <h1 className='Integration-SubHeadingText text-[24px] text-white/70  text-start self-start break-keep mt-[50px] pr-90'>Is your desired connection or integration not listed? No problem, we’ll build it for you!</h1>
                ...
                <div className="IntegrationCard-cont w-[100%] grid grid-cols-3 gap-8 my-20 px-[54px]  text-white overflow-hidden ">
                    <div className="integrationCard flex flex-col gap-5">
                        ...
                        <h1 className='text-2xl'>Akeneo</h1>
                    ...
                    <div className="integrationCard flex flex-col gap-5">
                        ...
                        <h1 className='text-2xl'>Exact Online</h1>
                    ...
                    <div className="integrationCard flex flex-col gap-5">
                        ...
                        <h1 className='text-2xl'>AFAS software</h1>
                    ...
                    <div className="integrationCard1 flex flex-col gap-5">
                        ...
                        <h1 className='text-2xl'>HubSpot</h1>
                    ...
                    <div className="integrationCard1 flex flex-col gap-5">
                        ...
                        <h1 className='text-2xl'>Bullhorn</h1>
                    ...
                    <div className="integrationCard1 flex flex-col gap-5">
                        ...
                        <h1 className='text-2xl'>Connexys</h1>
                    ...
                    <div className="integrationCard1 flex flex-col gap-5">
                        ...
                        <h1 className='text-2xl'>xPlan</h1>
                    ...
                    <div className="integrationCard1 flex flex-col gap-5">
                        ...
                        <h1 className='text-2xl'>Salesforce</h1>
                    ...
                    <div className="integrationCard1 flex flex-col gap-5">
                        ...
                        <h1 className='text-2xl'>Mollie</h1>
                    ...
                    <div className="integrationCard1 flex flex-col gap-5">
                        ...
                        <h1 className='text-2xl'>Mailchimp</h1>
                    ...
                    <div className="integrationCard1 flex flex-col gap-5">
                        ...
                        <h1 className='text-2xl'>ActiveCampaign</h1>
                    ...
                    <div className="integrationCard1 flex flex-col gap-5">
                        ...
                        <h1 className='text-2xl'>SURFconext</h1>

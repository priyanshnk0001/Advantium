        ...
        <div className='w-[100%] h-[100vh] bg-gray-900 flex justify-around items-center overflow-hidden   '>
            ...
            <div className="flextext-cont w-[25%] h-[90%] ">
                ...
                <div className="flex-subchild rounded-4xl overflow-hidden  ">
                        <div className="flexItm flex justify-between items-center border-b-1  border-gray-400      py-5">
                            <div className='flex items-center pl-7'>
                                <h1 className='text-[20px] text-white'>1. Flexible webdesign</h1>
                            </div>
                ...
                <div className="flex-subchild rounded-4xl overflow-hidden ">
                        <div className="flexItm flex justify-between items-center border-b-1  border-gray-400    py-5">
                            <div className='flex items-center pl-7'>
                                <h1 className='text-[20px] text-white'>2. User goals</h1>
                            </div>
                ...
                <div className="flex-subchild rounded-4xl overflow-hidden ">
                        <div className="flexItm flex justify-between items-center border-b-1  border-gray-400    py-5">
                            <div className='flex items-center pl-7'>
                                <h1 className='text-[20px] text-white'>3. Concrete choices</h1>
                            </div>
                ...
                <div className="flex-subchild rounded-4xl overflow-hidden .pppp ">
                    <div className="flexItm flex justify-between items-center border-b-1  border-gray-400    py-5">
                        <div className='flex items-center pl-7'>
                            <h1 className='text-[20px] text-white'>4. Components</h1>
                        </div>
                ...
                <div className="flex-subchild rounded-4xl overflow-hidden ">
                    <div className="flexItm flex justify-between items-center border-b-1  border-gray-400    py-5">
                        <div className='flex items-center pl-7'>
                            <h1 className='text-[20px] text-white'>5. Development</h1>
                        </div>
                ...
                <div className="flex-subchild rounded-4xl overflow-hidden ">
                    <div className="flexItm flex justify-between items-center border-b-1  border-gray-400    py-5">
                        <div className='flex items-center pl-7'>
                            <h1 className='text-[20px] text-white'>6. Delivery</h1>
                        </div>
                ...
                <div className="flex-subchild rounded-4xl overflow-hidden ">
                    <div className="flexItm flex justify-between items-center border-b-1  border-gray-400    py-5">
                        <div className='flex items-center pl-7'>
                            <h1 className='text-[20px] text-white'>7. Service & management</h1>
                        </div>

...
export default function DesignSplitText() {
    ...
    return (
        <div className="DesignsplitText-container  w-full min-h-[100vh]  flex flex-col   justify-center whitespace-normal break-words mt-20 px-45 overflow-x-hidden  ">
            <h1 className="Design-Text text-start py-5 text-[55px] text-white flex items-center">Leading the way together.</h1>
            <div
                ref={elRef}
            ...
            >
               ...
               <div >
                 <h1 className="text-[45px] text-white">Your contribution to Advantium.</h1>

                
                    <h1 className="text-white/80 space-y-5"><span className="text-white font-bold">Be inquisitive:</span> You are eager to learn and always looking for ways to develop yourself and others.</h1>
                    <h1 className="text-white/80 space-y-5"><span className="text-white font-bold">Learn by doing:</span> You like to get to grips with things and are not afraid to take on new challenges.</h1>
                    <h1 className="text-white/80 space-y-5"><span className="text-white font-bold">Make others successful:</span> Collaboration and knowledge sharing come naturally to you.</h1>
                    <h1 className="text-white/80 space-y-5"><span className="text-white font-bold">Take responsibility: </span> You feel committed and always strive for the best result.</h1>
               
               </div>


               <div>
                 <h1 className="text-[45px] text-white">In addition, we think it's important that you:</h1>
               ...
               <div>
                 <h1 className="text-[45px] text-white">Why choose Advantium?</h1>

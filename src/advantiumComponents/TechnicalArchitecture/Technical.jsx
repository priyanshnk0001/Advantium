...
function Technical() {
    ...
    window.addEventListener('load', () => window.scrollTo(0, 0));
           const moreTechArchRef = useRef(null);
        
          // scroll function
          const scrollTomoreTechArch = () => {
            if (!moreTechArchRef.current) return;
        
            moreTechArchRef.current.scrollIntoView({ behavior: 'smooth', block: 'start' });
          };
                ...
                <div className="CM-main-container w-[100%]     flex flex-col justify-center items-center  text-start ">
                    <div className="CM-container1 w-[100%] mt-50  flex justify-around">
                        <div className="CM1-child1 w-[45%] flex flex-col gap-7">
                            ...
                            <h1 className='text-gray-300 text-[18px] '>Setting up a strong technical architecture is essential so that your systems not only work well, but are also flexible, secure and ready for the future. We design the technical foundation you need for your digital systems, so that everything fits together properly.</h1>
                    ...
                    <div ref={moreTechArchRef} className="CM-container3 w-[100%] my-30  flex justify-around items-center">

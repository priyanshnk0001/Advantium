...
function Nou() {
    ...
    return (
        <div className='Nou-main-cont w-[100%] flex flex-col  bg-white ' >
            ...
            <div className="Nou-text-imagediv02 w-[100vw] h-[500px] flex justify-between mb-20 lg:mt-0 md:mt-70  px-40">
                <div className="textpart w-[50%] flex flex-col justify-center pr-10 gap-5">
                    <h1 className="text-4xl">
            ...
            <div className='Nou-text04-cont flex flex-col lg:my-20 md:mt-70 gap-5 px-40'>
